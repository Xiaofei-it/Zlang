...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).cast(input[1]);
//            }
//        }
...
//            public Object call(Object[] input) {
//                try {
//                    return STORAGE.getClass((String) input[0]);
//                } catch (ClassNotFoundException e) {
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).getSuperclass();
//            }
//        }
//
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).isAnonymousClass();
//            }
//        }
        ...
        private static class IsArray implements JavaFunction {
            ...
            @Override
            public String getFunctionName() {
                return "_is_array_class";
            }

            @Override
            public Object call(Object[] input) {
                return obtainClass(input[0]).isArray();
            }
        }
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).isAssignableFrom(obtainClass(input[1]);
//            }
//        }
        ...
        private static class IsEnum implements JavaFunction {
            ...
            @Override
            public Object call(Object[] input) {
                return obtainClass(input[0]).isEnum();
            }
        }
        ...
        private static class InstanceOf implements JavaFunction {
            ...
            @Override
            public Object call(Object[] input) {
                return obtainClass(input[1]).isInstance(input[0]);
            }
        }
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).isInterface();
//            }
//        }
//
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).isLocalClass();
//            }
//        }
//
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).isMemberClass();
//            }
//        }
        ...
        private static class IsPrimitive implements JavaFunction {
            ...
            @Override
            public String getFunctionName() {
                return "_is_primitive_class";
            }

            @Override
            public Object call(Object[] input) {
                return obtainClass(input[0]).isPrimitive();
            }
        }
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).getEnclosingClass();
//            }
//        }
//
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).getDeclaringClass();
//            }
//        }
//
...
//            @Override
//            public Object call(Object[] input) {
//                return obtainClass(input[0]).getEnclosingMethod();
//            }
//        }
    }
